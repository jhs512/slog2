...
public class NotProd {
    ...
    public void work1() {
        ...
        Post post1 = postService.write(memberUser1, "제목 1", "내용 1", true, true).getData();
        Post post2 = postService.write(memberUser1, "제목 2", "내용 2", true, true).getData();

        Post post3 = postService.write(memberUser2, "제목 3", "내용 3", true, true).getData();
        Post post4 = postService.write(memberUser2, "제목 4", "내용 4", true, true).getData();
    }
}